...
class MagnitParser:
    ...
    def __init__(self, start_url):
        ...
        self.dict_months = {"янв": 1, "фев": 2, "мар": 3, "апр": 4, "май": 5, "мая": 5, "июн": 6, "июл": 7, "авг": 8,
                            "сен": 9, "окт": 10, "ноя": 11, "дек": 12}
        mongo_client = pm.MongoClient(os.getenv('DATA_BASE'))
        self.db = mongo_client['parse_magnit_promo']
    ...
    def date_parse(self, date_string: str):
        ...
        for date in date_list:
            ...
            yield dt.datetime(day=int(temp_date[0]), month=self.dict_months[temp_date[1][:3]], year=dt.datetime.now().year)
